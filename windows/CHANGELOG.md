...
### Fixed
- **Capture pickers no longer flash as oversized blank windows** — the Region/Screen/Window picker surfaces are now sized and positioned before first activation, and the region selector commits its screen-snapshot backdrop before showing the full-screen overlay.
